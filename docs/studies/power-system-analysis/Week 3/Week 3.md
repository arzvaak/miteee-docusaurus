...
$$
D_s = (r' dot 2 r dot 2 r dot 2 sqrt(2) r dot r)^(1/4)
$$
...
$$
D_(s 1) = (r' dot 2 r dot 2 r dot 2 sqrt(2) r)^(1/4)
$$

Since the configuration is symmetric, all four conductors have the same self-GMD, so:
$$
D_s = D_(s 1) = (r' dot 2 r dot 2 r dot 2 sqrt(2) r)^(1/4)
$$

Substituting r′ = 0.7788r:
$$
D_s = (0.7788 r dot 2 r dot 2 r dot 2 sqrt(2) r)^(1/4)
$$
$$
D_s = (0.7788 times 2 times 2 times 2 sqrt(2))^(1/4) dot r
$$
$$
D_s = (0.7788 times 8 sqrt(2))^(1/4) dot r
$$
$$
D_s = (8.809)^(1/4) dot r
$$
...
$$
D_s = (r' dot 2 r dot 2 r dot 2 sqrt(2) r)^(1/4)
$$
...
**Simplification**:
$$
D_s = (0.7788 times 8 sqrt(2))^(1/4) dot r = 1.722 r
$$
...
**Due to current I_a**:
$$
lambda_(12)(I_a) = 0.4605 dot I_a dot log(frac(D_(a 2), D_(a 1))) " mWb-T/km"
$$

**Due to current I_b**:
$$
lambda_(12)(I_b) = 0.4605 dot I_b dot log(frac(D_(b 2), D_(b 1))) " mWb-T/km"
$$
...
$$
lambda_(12) = 0.4605[I_a log(frac(D_(a 2), D_(a 1))) + I_b log(frac(D_(b 2), D_(b 1)))] " mWb-T/km"
$$
...
$$
I_b = I_a angle -120^degree
$$

$$
lambda_(12) = 0.4605 I_a [log(frac(D_(a 2), D_(a 1))) + 1 angle -120^degree log(frac(D_(b 2), D_(b 1)))] " mWb-T/km"
$$

**Numerical Substitution**:

$$
lambda_(12) = 0.4605 times 150 angle 0^degree [log(frac(9.484, 8.41)) + 1 angle -120^degree log(frac(6.096, 5.25))] " mWb-T/km"
$$
...
So:
$$
lambda_(12) = 0.4605 times 150 [0.0522 + 0.0649 angle -120^degree]
$$
...
So:
$$
lambda_(12) = 0.4605 times 150 times 0.0596 angle -70.6^degree
$$
$$
lambda_(12) = 4.112 angle -70.6^degree " mWb-T/km"
$$
...
$$
V = frac(d, dif t) lambda_(12)(t) = -sqrt(2) omega|lambda_(12)|sin(omega t + alpha)
$$

**Alternative form**:
$$
V = sqrt(2) omega|lambda_(12)|cos(omega t + alpha + 90^degree) " V/km"
$$

**RMS voltage**:
$$
V_("rms") = omega|lambda_(12)| angle(alpha + 90^degree) " V/km"
$$
...
$$
V_("rms") = 2 pi times 50 times 4.112 times 10^(-3) angle(-70.6^degree + 90^degree)
$$

$$
V_("rms") = 314.16 times 4.112 times 10^(-3) angle 19.4^degree
$$

$$
V_("rms") = 1.291 angle 19.4^degree " V/km"
$$
...
$$
E_y = frac(q, 2 pi epsilon_0 y) " V/m" space dots.h (1)
$$
...
$$
V_(12) = integral_(D_1)^(D_2) E_y "dy" = integral_(D_1)^(D_2) frac(q, 2 pi epsilon_0 y) "dy"
$$

$$
V_(12) = frac(q, 2 pi epsilon_0) ln(frac(D_2, D_1)) " volts" space dots.h (2)
$$
...
$$
V_("ki")(q_m) = frac(q_m, 2 pi epsilon_0) ln(frac(D_("im"), D_("km"))) " volts" space dots.h (4)
$$
...
$$
V_("ki") = frac(1, 2 pi epsilon_0) sum_(m=1)^(N) q_m ln(frac(D_("im"), D_("km"))) " volts" space dots.h (5)
$$
...
$$
V_(12) = frac(1, 2 pi epsilon_0)(q_1 ln frac(D_(21), D_(11)) + q_2 ln frac(D_(22), D_(12)))
$$
...
$$
V_(12) = frac(1, 2 pi epsilon_0)(q_1 ln frac(D, r_1) - q_1 ln frac(r_2, D))
$$

**Simplification**:
$$
V_(12) = frac(2 q_1, 2 pi epsilon_0) ln(frac(D, sqrt(r_1 r_2))) " volts"
$$

Let me verify this simplification step by step:
$$
V_(12) = frac(q_1, 2 pi epsilon_0)[ln(frac(D, r_1)) - ln(frac(r_2, D))]
$$
$$
V_(12) = frac(q_1, 2 pi epsilon_0)[ln(frac(D, r_1)) + ln(frac(D, r_2))]
$$
$$
V_(12) = frac(q_1, 2 pi epsilon_0) ln(frac(D^2, r_1 r_2))
$$
$$
V_(12) = frac(2 q_1, 2 pi epsilon_0) ln(frac(D, sqrt(r_1 r_2)))
$$

**Line-to-Line Capacitance**:

$$
C_(12) = frac(q_1, V_(12)) = frac(pi epsilon_0, ln(frac(D, sqrt(r_1 r_2)))) " F/m" space dots.h (7)
$$

**For equal conductor radii (r₁ = r₂ = r)**:
$$
C_(12) = frac(pi epsilon_0, ln(frac(D, r))) " F/m" space dots.h (8)
$$

**In practical units**:
$$
C_(12) = frac(0.0121, log(frac(D, r))) " μF/km" space dots.h (9)
$$
...
$$
C_(1 n) = C_(2 n) = frac(0.0242, log(frac(D, r))) " μF/km" space dots.h (10)
$$
...
**Section 1 (V_ab(1))**:
$$
V_("ab")(1) = frac(1, 2 pi epsilon_0)(q_a ln frac(D_(12), r) + q_b ln frac(r, D_(12)) + q_c ln frac(D_(23), D_(31))) space dots.h (13)
$$

**Section 2 (V_ab(2))**:
$$
V_("ab")(2) = frac(1, 2 pi epsilon_0)(q_a ln frac(D_(23), r) + q_b ln frac(r, D_(23)) + q_c ln frac(D_(31), D_(12))) space dots.h (14)
$$

**Section 3 (V_ab(3))**:
$$
V_("ab")(3) = frac(1, 2 pi epsilon_0)(q_a ln frac(D_(31), r) + q_b ln frac(r, D_(31)) + q_c ln frac(D_(12), D_(23))) space dots.h (15)
$$
...
$$
V_("ab") = frac(1, 2 pi epsilon_0)[q_a ln(frac(D_("eq"), r)) + q_b ln(frac(r, D_("eq")))] space dots.h (16)
$$

**Where**:
$$
D_("eq") = (D_(12) D_(23) D_(31))^(1/3) = (D_("ab") D_("bc") D_("ca"))^(1/3) space dots.h (17)
$$
...
$$
V_("ac") = frac(1, 2 pi epsilon_0)[q_a ln(frac(D_("eq"), r)) + q_c ln(frac(r, D_("eq")))] space dots.h (18)
$$

**Adding Equations (16) and (18)**:

$$
V_("ab") + V_("ac") = frac(1, 2 pi epsilon_0)[2 q_a ln(frac(D_("eq"), r)) + (q_b + q_c) ln(frac(r, D_("eq")))] space dots.h (19)
$$

**Using q_b + q_c = −q_a from equation (12)**:
$$
V_("ab") + V_("ac") = frac(3 q_a, 2 pi epsilon_0) ln(frac(D_("eq"), r)) space dots.h (20)
$$
...
$$
V_("ab") = V_("an") - V_("bn") space dots.h (21)
$$
$$
V_("ac") = V_("an") - V_("cn") space dots.h (22)
$$

**Phase relationships**:
$$
V_("bn") = V_("an") angle -120^degree space dots.h (23)
$$
$$
V_("cn") = V_("an") angle -240^degree space dots.h (24)
$$

**Adding equations (21) and (22) with substitutions**:
$$
V_("ab") + V_("ac") = 3 V_("an") space dots.h (25)
$$
...
$$
frac(3 q_a, 2 pi epsilon_0) ln(frac(D_("eq"), r)) = 3 V_("an")
$$

$$
frac(q_a, 2 pi epsilon_0) ln(frac(D_("eq"), r)) = V_("an") space dots.h (26)
$$

**Capacitance to Neutral**:

$$
C_("an") = frac(q_a, V_("an")) = frac(2 pi epsilon_0, ln(frac(D_("eq"), r))) " F/m" space dots.h (27)
$$

**In practical units**:
$$
C_("an") = frac(0.0242, log(frac(D_("eq"), r))) " μF/km" space dots.h (28)
$$
...
$$
C_("an") = frac(0.0242, log(frac(D, r))) " μF/km" space dots.h (29)
$$

**Line Charging Current for 3-Phase Line**:

$$
I_("charging") = j omega C_("an") V_("LN") " A/phase/km" space dots.h (30)
$$
...
$$
D_s = (r dot d)^(1/2) space dots.h (31)
$$

**3-conductor arrangement** (equilateral triangle):
$$
D_s = (r dot d^2)^(1/3) space dots.h (32)
$$

**4-conductor arrangement** (quadruplex):
$$
D_s = (sqrt(2) dot r dot d^3)^(1/4) space dots.h (33)
$$

**General Formula for Transposed Line with Bundled Conductors**:

$$
C_("an") = frac(0.0242, log(frac(D_("eq"), D_s))) " μF/km" space dots.h (34)
$$
...
$$
V_("ac")(1) = frac(1, 2 pi epsilon_0)(q_a ln frac(D_(13), r) + q_b ln frac(D_(23), D_(12)) + q_c ln frac(r, D_(13)))
$$
...
$$
V_("ac")(2) = frac(1, 2 pi epsilon_0)(q_a ln frac(D_(23), r) + q_b ln frac(D_(31), D_(12)) + q_c ln frac(r, D_(23)))
$$

**Section 3** (positions: b, c, a):
$$
V_("ac")(3) = frac(1, 2 pi epsilon_0)(q_a ln frac(D_(31), r) + q_b ln frac(D_(12), D_(23)) + q_c ln frac(r, D_(31)))
$$
...
$$
V_("ac") = frac(1, 2 pi epsilon_0)[q_a ln(frac(D_("eq"), r)) + q_c ln(frac(r, D_("eq")))]
$$
...
$$
C_("an") = frac(0.0242, log(frac(D_("eq"), D_s))) " μF/km" space dots.h (35)
$$

**Calculation of D_eq**:

$$
D_("eq") = (D_("ab") dot D_("bc") dot D_("ca"))^(1/3) space dots.h (36)
$$

**For D_ab** (all four distance combinations):
$$
D_("ab") = (d_("ab") dot d_("ab'") dot d_("a'b") dot d_("a'b'"))^(1/4) = (D dot d_2 dot D dot d_2)^(1/4) = (D dot d_2)^(1/2)
$$
...
**For D_ca**:
$$
D_("ca") = (d_("ca") dot d_("ca'") dot d_("c'a") dot d_("c'a'"))^(1/4) = (d_5 dot d_1 dot d_5 dot d_1)^(1/4) = (d_1 dot d_5)^(1/2)
$$

**Final expression**:
$$
D_("eq") = D^(1/3) dot d_2^(1/3) dot d_1^(1/6) dot d_5^(1/6) space dots.h (38)
$$
...
$$
D_s = (D_("sa") dot D_("sb") dot D_("sc"))^(1/3) space dots.h (37)
$$
...
**Final expression**:
$$
D_s = r^(1/2) dot d_3^(1/3) dot d_4^(1/6) space dots.h (39)
$$
...
$$
C_("an") = frac(0.0242, log(frac(D^(1/3) d_2^(1/3) d_1^(1/6) d_5^(1/6), r^(1/2) d_3^(1/3) d_4^(1/6)))) " μF/km" space dots.h (40)
$$
...
$$
V_(12) = frac(1, 2 pi epsilon_0)(q_1 ln frac(D_(21), D_(11)) + q_2 ln frac(D_(22), D_(12)) + q_3 ln frac(D_(23), D_(13)) + q_4 ln frac(D_(24), D_(14))) space dots.h (41)
$$

**After substitution and simplification**:
$$
V_(12) = frac(q, pi epsilon_0) ln[frac(2 "Dh", r sqrt(4 h^2 + D^2))]
$$

**Alternative form**:
$$
V_(12) = frac(q, pi epsilon_0) ln[frac(D, r(1 + frac(D^2, 4 h^2))^(1/2))] " volts" space dots.h (42)
$$
...
$$
C_(12) = frac(pi epsilon_0, ln(frac(D, r(1 + frac(D^2, 4 h^2))^(1/2)))) " F/m" space dots.h (43)
$$

**In practical units**:
$$
C_(12) = frac(0.0121, log(frac(D, r(1 + frac(D^2, 4 h^2))^(1/2)))) " μF/km" space dots.h (44)
$$
...
$$
D_s = (r_0 dot d dot r_0 dot d)^(1/4) = (r_0 dot d)^(1/2)
$$

$$
D_s = sqrt(0.012 times 0.4) = 0.0693 " m"
$$

**Step 2: Calculate D_eq**

$$
D_("eq") = (D_("ab") dot D_("bc") dot D_("ca"))^(1/3)
$$

**For D_ab**:
$$
D_("ab") = (d_("ab") dot d_("ab'") dot d_("a'b") dot d_("a'b'"))^(1/4) = (20 times 10.4 times 9.6 times 10)^(1/4) = 9.995 " m"
$$
...
**Therefore**:
$$
D_("eq") = (9.995 times 9.995 times 19.997)^(1/3) = 12.534 " m"
$$

**Approximate check**:
$$
D_("eq")(approx) = (10 times 10 times 20)^(1/3) = 12.599 " m" " vs " 12.6 " m"
$$
...
$$
C_("an") = frac(0.0242, log(frac(D_("eq"), D_s))) = frac(0.0242, log(frac(12.6, 0.0693))) " μF/km"
$$

$$
C_("an") = 0.0107096 " μF/km"
$$

**Total capacitance for 250 km**:
$$
C_("an") = 0.0107096 times 250 = 2.677 times 10^(-6) " F"
$$
...
$$
|V_("LN")| = |V_("an")| = frac(220, sqrt(3)) " kV"
$$

$$
|I_("chg")| = 2 pi times 50 times 2.677 times 10^(-6) times frac(220, sqrt(3))
$$

$$
|I_("chg")| = 0.1068 " kA/phase"
$$
...
$$
Q_(c,3-"phase") = 2 pi times 50 times 2.677 times 10^(-6) times (220)^2
$$

$$
Q_(c,3-"phase") = 40.70 " MVAR"
$$
...
$$
C_(12)("earth") = frac(0.0121, log(frac(D, r(1 + frac(D^2, 4 h^2))^(1/2))))
$$

$$
C_(12)("earth") = frac(0.0121, log(frac(3.5, 0.01(1 + frac(3.5^2, 4 times 8^2))^(1/2))))
$$
...
$$
C_(12)("earth") = 0.00477 " μF/km"
$$

**Line-to-neutral capacitance with earth effect**:
$$
C_(1 n)("earth") = C_(2 n)("earth") = 2 C_(12)("earth") = 0.00955 " μF/km"
$$
...
$$
C_(1 n) = C_(2 n) = frac(0.0242, log(frac(D, r))) = frac(0.0242, log(frac(3.5, 0.01)))
$$
...
$$
C_(1 n) = 0.00951 " μF/km"
$$

**Comparison**:

$$
frac(C_(1 n)("earth"), C_(1 n)) = frac(0.00955, 0.00951) = 1.0042
$$
...
$$
d_2 = sqrt(4^2 + 8.25^2) = 9.168 " m"
$$

$$
d_3 = sqrt(8^2 + 7.5^2) = 10.965 " m"
$$

$$
d_5 = 8 " m" " (vertical distance)"
$$
...
Using equation (38):
$$
D_("eq") = D^(1/3) dot d_2^(1/3) dot d_1^(1/6) dot d_5^(1/6)
$$

$$
D_("eq") = 4.07^(1/3) times 9.168^(1/3) times 7.5^(1/6) times 8^(1/6)
$$
...
Using equation (39):
$$
D_s = r^(1/2) dot d_3^(1/3) dot d_4^(1/6)
$$

$$
D_s = (0.02)^(1/2) times (10.965)^(1/3) times (9)^(1/6) = 0.453 " m"
$$
...
$$
C_("an") = frac(0.0242, log(frac(6.61, 0.453))) = 0.02078 " μF/km"
$$
...
$$
C_("an") = 0.02078 times 200 = 4.157 " μF"
$$
...
$$
|V_("LN")| = frac(220, sqrt(3)) " kV"
$$

$$
|I_("chg")| = 2 pi times 50 times 4.157 times 10^(-6) times frac(220, sqrt(3))
$$

$$
|I_("chg")| = 0.1658 " kA/phase" = 165.8 " A/phase"
$$
...
$$
h = sqrt(d^2 - (frac(d, 2))^2) = sqrt(0.1^2 - 0.05^2)
$$
...
$$
D_("SA") = (r dot d dot d)^(1/3) = (r d^2)^(1/3)
$$
...
$$
D_("SA") = [(r d^2) dot (r d^2) dot (r d^2)]^(1/9) = (r d^2)^(1/3)
$$

**Worked Numerical Example**:
- Given: r = 0.0670067 m, d = 0.9 m
- $D_("SA") = (0.0670067 times 0.9^2)^(1/3) = 0.0406$ meter
...
$$
D_("SB") = (r dot d dot 2 d dot r dot d dot d dot r dot d dot 2 d)^(1/9)
$$

After simplification:
$$
D_("SB") = (r)^(1/3) dot (d)^(2/3) dot (4)^(1/9)
$$

**Worked Numerical Example**:
- Given: r = 0.0067 m, d = 0.1 m
- $D_("SB") = (0.0067)^(1/3) times (0.1)^(2/3) times (4)^(1/9) = 0.0473$ meter

**Mutual GMD Calculation (D_eq)**:

With 3 conductors in each group, there are 3 × 3 = 9 distance combinations:
$$
D_("eq") = (d_(a 1 b 1) dot d_(a 1 b 2) dot d_(a 1 b 3) dot d_(a 2 b 1) dot d_(a 2 b 2) dot d_(a 2 b 3) dot d_(a 3 b 1) dot d_(a 3 b 2) dot d_(a 3 b 3))^(1/9)
$$
...
- $d_(a 3 b 2) = ((0.0866)^2 + (6.15)^2)^(1/2) = 6.1506$ m
- $d_(a 3 b 1) = ((0.0866)^2 + (6.05)^2)^(1/2) = 6.05606$ m
- $d_(a 3 b 3) = ((0.0866)^2 + (6.25)^2)^(1/2) = 6.2506$ m
...
Where:
- $epsilon_0 = 8.854 times 10^(-12)$ F/m (permittivity of free space)
...
1. **Self-GMD**:
$$
D_s = (r dot d)^(1/2) = (0.01 times 0.6)^(1/2) = 0.07746 " m"
$$

2. **Mutual GMD between phases**:
$$
D_("ab") = (d_("ab") dot d_("ab'") dot d_("a'b") dot d_("a'b'"))^(1/4)
$$
...
$$
D_("ca") = (12 times 12.015 times 12.015 times 12)^(1/4) = 12.0075 " m"
$$

4. **Equivalent GMD**:
$$
D_("eq") = (D_("ab") dot D_("bc") dot D_("ca"))^(1/3) = (6.015 times 6.015 times 12.0075)^(1/3) = 7.573 " m"
$$

5. **Capacitance** (Equation 34):
$$
C_("an") = frac(0.0242, log frac(D_("eq"), D_s)) " μF/km"
$$
...
For $V_("ab")$:
$$
V_("ab") = frac(1, 2 pi epsilon_0) [ q_a ln(frac(D, r)) + q_b ln(frac(r, d)) + q_c ln(frac(D, 2 D)) ] = V angle 30° space "...(i)"
$$

For $V_("ac")$:
$$
V_("ac") = frac(1, 2 pi epsilon_0) [ q_a ln(frac(2 D, r)) + q_b ln(frac(D, D)) + q_c ln(frac(r, 2 D)) ] = V angle -30° space "...(ii)"
$$
...
$$
$$
therefore q_b = -(q_a + q_c) space "...(iii)"
$$
...
$$
2 q_a ln(frac(D, r)) + q_c ln(frac(D, 2 r)) = 2 pi epsilon_0 dot V angle -30° space "...(iv)"
$$

**Solving for $q_a$**:

$$
q_a = frac(2 pi epsilon_0 [ ln(frac(r, d)) angle 30° - ln(frac(D, 2 r)) angle -30° ], [ 2 dot ln(frac(D, r)) dot ln(frac(r, D)) - ln(frac(2 D, r)) dot ln(frac(r, 2 D)) ]) " coulomb/meter"
$$
...
$$
I_("ca") = omega dot q_a angle 90°
$$

Or equivalently:
$$
I_("ca") = 2 pi f dot q_a angle 90° " ampere"
$$
...
**Mutual GMD**:
$$
D_("eq") = (D_("aa'") dot D_("ab'") dot D_("ba'") dot D_("bb'") dot D_("ca'") dot D_("cb'"))^(1/6)
$$
...
$$
D_("eq") = (6 times 7.11 times 7.11 times 6 times 10 times 7.11)^(1/6) = 7.162 " m"
$$
...
$$
D_("sx") = (D_("aa") dot D_("ab") dot D_("ac") dot D_("ba") dot D_("bb") dot D_("bc") dot D_("ca") dot D_("cb") dot D_("cc"))^(1/9)
$$

Where $D_("aa") = D_("bb") = D_("cc") = r_x$

$$
D_("sx") = (0.001 times 0.4^4 times 8^2)^(1/9) = 0.294 " m"
$$

**Self-GMD for Group Y**:
$$
D_("sy") = (d_("a'a'") dot d_("a'b'"))^(1/2) = 0.0894 " m"
$$

**Capacitance** (Equation 7):
$$
C_("xy") = frac(pi epsilon_0, ln frac(D_("eq"), sqrt(D_("sx") D_("sy")))) " farad/meter"
$$
...
For 3-phase systems:
$$
S_("base",3 phi.alt) = sqrt(3) dot V_("base","LL") dot I_("base")
$$
$$
Z_("base") = frac(V_("base","LL")^2, S_("base",3 phi.alt))
$$

**Per-Unit Impedance**:
$$
Z_("pu") = frac(Z_("actual"), Z_("base")) = frac(Z_("actual") dot S_("base"), V_("base")^2)
$$
...
$$
Z_("pu","new") = Z_("pu","old") dot frac(S_("base","new"), S_("base","old")) dot (frac(V_("base","old"), V_("base","new")))^2
$$
...
![Three- and four-strand GMR worked-example sketches](/content-assets/studies/power-system-analysis/Week%203/Assets/img-0.jpg)
...
![Three-phase power line and telephone line induction geometry](/content-assets/studies/power-system-analysis/Week%203/Assets/img-2.jpg)
...
![Handwritten line-to-line and line-to-neutral capacitance equations](/content-assets/studies/power-system-analysis/Week%203/Assets/img-21.jpg)
...
![Handwritten bundle self-GMD formulas for two, three, and four conductors](/content-assets/studies/power-system-analysis/Week%203/Assets/img-30.jpg)
...
![Handwritten double-circuit capacitance derivation](/content-assets/studies/power-system-analysis/Week%203/Assets/img-35.jpg)
...
![Handwritten bundled-line capacitance calculation](/content-assets/studies/power-system-analysis/Week%203/Assets/img-55.jpg)
...
![Balanced three-phase network beside its single-phase equivalent](/content-assets/studies/power-system-analysis/Week%203/Assets/img-69.jpg)
...
![Four three-phase transformer connection arrangements](/content-assets/studies/power-system-analysis/Week%203/Assets/img-71.jpg)
