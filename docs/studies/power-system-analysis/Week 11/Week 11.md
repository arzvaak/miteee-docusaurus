...
$$
mat(V_a; V_b; V_c) = mat(Z_s, Z_m, Z_m; Z_m, Z_s, Z_m; Z_m, Z_m, Z_s) mat(I_a; I_b; I_c)
$$
...
$$
A V_s = Z_("abc") dot A I_s
$$

Multiply both sides by A⁻¹:

$$
mat(V_(a 1); V_(a 2); V_(a 0)) = frac(1, 3) mat(1, beta, beta^2; 1, beta^2, beta; 1, 1, 1) bold(Z)_("abc") bold(A) mat(I_(a 1); I_(a 2); I_(a 0))
$$
...
$$
mat(V_(a 1); V_(a 2); V_(a 0)) = mat(Z_s - Z_m, 0, 0; 0, Z_s - Z_m, 0; 0, 0, Z_s + 2 Z_m) mat(I_(a 1); I_(a 2); I_(a 0))
$$
...
$$
15 angle-60^degree + 10 angle 30^degree + I_c = 0
$$

$$
bold(I)_c = 18 angle 154^degree " A"
$$

**Step 2: Positive-sequence component of line current**

$$
bold(I)_(a 1) = frac(1, 3)(bold(I)_a + beta bold(I)_b + beta^2 bold(I)_c)
$$

$$
= frac(1, 3)(15 angle-60^degree + 10 angle(30^degree+120^degree) + 18 angle(154^degree+240^degree))
$$
...
$$
bold(I)_(a 2) = frac(1, 3)(bold(I)_a + beta^2 bold(I)_b + beta bold(I)_c)
$$

$$
= frac(1, 3)(15 angle-60^degree + 10 angle(30^degree+240^degree) + 18 angle(154^degree+120^degree))
$$
...
$$
bold(I)_(a 0) = frac(1, 3)(bold(I)_a + bold(I)_b + bold(I)_c) = 0 " A"
$$
...
$$
frac(3 R dot 3 R, 3 R + 3 R + 3 R) = R
$$
...
$$
bold(I)_("ab") = frac(1, 3)(15 angle-60^degree - 10 angle 30^degree) = 6.01 angle-266.3^degree " A"
$$

$$
bold(I)_("bc") = frac(1, 3)(bold(I)_b - bold(I)_c) = frac(1, 3)(10 angle 30^degree - 18 angle 154^degree) = 8.33 angle-6.64^degree " A"
$$

$$
bold(I)_("ca") = frac(1, 3)(bold(I)_c - bold(I)_a) = frac(1, 3)(18 angle 154^degree - 15 angle-60^degree) = 10.52 angle 138.6^degree " A"
$$
...
$$
bold(I)_("ab" 1) = frac(1, 3)(bold(I)_("ab") + beta bold(I)_("bc") + beta^2 bold(I)_("ca"))
$$

$$
= frac(1, 3)(6.01 angle-266.3^degree + 8.33 angle(-6.64^degree+120^degree) + 10.52 angle(138.6^degree+240^degree))
$$

**Result:** **I_ab1 = 2.67∠38.5° A**

$$
bold(I)_("ab" 2) = frac(1, 3)(bold(I)_("ab") + beta^2 bold(I)_("bc") + beta bold(I)_("ca"))
$$

**Result:** **I_ab2 = 8.06∠−107.9° A**

$$
bold(I)_("ab" 0) = frac(1, 3)(bold(I)_("ab") + bold(I)_("bc") + bold(I)_("ca")) = 0 " A"
$$
...
$$
bold(I)_(a 1) = frac(1, 3)(bold(I)_a + beta bold(I)_c + beta^2 bold(I)_b) = frac(1, 3)(15 angle 0^degree + 15 angle(180^degree+120^degree) + 0)
$$
...
$$
bold(I)_(a 2) = frac(1, 3)(bold(I)_a + beta^2 bold(I)_c + beta bold(I)_b)
$$
...
$$
bold(I)_(a 0) = frac(1, 3)(bold(I)_a + bold(I)_c + bold(I)_b) = 0 " A"
$$
...
$$
X_(T 1) = X_(T 2) = 0.1 times frac(50, 60) times (frac(10.8, 11))^2 = 0.0805 " p.u."
$$

**Step 3: Line reactances**

$$
"Line reactance (positive and negative sequence)" = 100 times frac(50, (123.2)^2) = 0.33 " p.u."
$$

$$
"Line reactance (zero sequence)" = frac(300 times 50, (123.2)^2) = 0.99 " p.u."
$$

**Step 4: Motor-1 reactances**

$$
"Reactance of motor-1 (positive and negative sequence)" = 0.25 times (frac(50, 30)) times (frac(10, 11))^2 = 0.345 " p.u."
$$

$$
"Zero sequence reactance of motor-1" = 0.06 times (frac(50, 30)) times (frac(10, 11))^2 = 0.082 " p.u."
$$
...
$$
"Reactance of motor-2 (positive and negative sequence)" = 0.25 times (frac(50, 15)) times (frac(10, 11))^2 = 0.69 " p.u."
$$

$$
"Zero sequence reactance of motor-2" = 0.06 times (frac(50, 15)) times (frac(10, 11))^2 = 0.164 " p.u."
$$

**Step 6: Neutral reactors**

$$
"Reactance of reactors" = 2.5 times frac(50, 11^2) = 1.033 " p.u."
$$
...
$$
mat(I_(a 1); I_(a 2); I_(a 0)) = frac(1, 3) mat(1, beta, beta^2; 1, beta^2, beta; 1, 1, 1) mat(I_a; 0; 0)
$$

**Result:**

$$
I_(a 1) = I_(a 2) = I_(a 0) = frac(1, 3) I_a
$$
...
$$
V_a = V_(a 1) + V_(a 2) + V_(a 0) = Z_f I_a = 3 Z_f I_(a 1)
$$
...
$$
I_(a 1) = frac(E_a, Z_1 + Z_2 + Z_0 + 3 Z_f)
$$

**Fault current:**

$$
I_a = 3 I_(a 1) = frac(3 E_a, Z_1 + Z_2 + Z_0 + 3 Z_f)
$$
...
$$
V_b = beta^2(E_a - Z_1 dot frac(1, 3) I_a) + beta(-Z_2 dot frac(1, 3) I_a) + (-Z_0 dot frac(1, 3) I_a)
$$

**After simplification:**

$$
V_b = E_a dot frac([3 beta^2 Z_f + Z_2(beta^2 - beta) + Z_0(beta^2 - 1)], Z_1 + Z_2 + Z_0 + 3 Z_f)
$$
...
$$
V_c = E_a dot frac([3 beta Z_f + Z_2(beta - beta^2) + Z_0(beta - 1)], Z_1 + Z_2 + Z_0 + 3 Z_f)
$$
...
$$
mat(I_(a 1); I_(a 2); I_(a 0)) = frac(1, 3) mat(1, beta, beta^2; 1, beta^2, beta; 1, 1, 1) mat(0; I_b; -I_b)
$$
...
$$
mat(V_(a 1); V_(a 2); V_(a 0)) = frac(1, 3) mat(1, beta, beta^2; 1, beta^2, beta; 1, 1, 1) mat(V_a; V_b; V_b - Z_f I_b)
$$
...
$$
3 V_(a 1) = V_a + (beta + beta^2) V_b - beta^2 Z_f I_b space dots (21)
$$

$$
3 V_(a 2) = V_a + (beta + beta^2) V_b - beta Z_f I_b space dots (22)
$$

**Subtracting:**

$$
3(V_(a 1) - V_(a 2)) = (beta - beta^2) Z_f I_b
$$
...
$$
I_(a 1) = frac(1, 3)(beta - beta^2) I_b = frac(j sqrt(3), 3) I_b
$$
...
$$
V_b = V_c = (I_b + I_c) Z_f = 3 Z_f I_(a 0) space dots (31)
$$
...
$$
mat(I_(a 1); I_(a 2); I_(a 0)) = frac(1, 3) mat(1, beta, beta^2; 1, beta^2, beta; 1, 1, 1) mat(0; I_b; I_c)
$$
...
$$
mat(V_(a 1); V_(a 2); V_(a 0)) = frac(1, 3) mat(1, beta, beta^2; 1, beta^2, beta; 1, 1, 1) mat(V_a; V_b; V_c)
$$

With V_c = V_b:

$$
V_(a 1) = V_(a 2) = frac(1, 3)[V_a + (beta^2 + beta) V_b]
$$

$$
V_(a 0) = frac(1, 3)(V_a + 2 V_b)
$$
...
$$
V_(a 0) - V_(a 1) = frac(1, 3)(2 - beta + beta^2) V_b
$$

**Using the identity:** 1 + β + β² = 0

$$
V_(a 0) - V_(a 1) = frac(1, 3)(3 - (1 + beta + beta^2)) V_b = frac(1, 3) dot 3 V_b = V_b
$$

**Therefore:**

$$
V_(a 0) = V_(a 1) + 3 Z_f I_(a 0)
$$
...
$$
bold(I_(a 1)) = frac(bold(E_a), Z_1 + frac(Z_2(Z_0 + 3 Z_f), Z_2 + Z_0 + 3 Z_f))
$$

$$
bold(I_(a 2)) = -(frac(bold(E_a) - bold(Z_1) bold(I_(a 1)), bold(Z_2)))
$$

$$
bold(I_(a 0)) = -(frac(bold(E_a) - bold(Z_1) bold(I_(a 1)), bold(Z_0) + 3 bold(Z_f)))
$$
...
$$
mat(V_("aa'1"); V_("aa'2"); V_("aa'0")) = frac(1, 3) mat(1, beta, beta^2; 1, beta^2, beta; 1, 1, 1) mat(V_("aa'"); V_("bb'"); V_("cc'")) = frac(1, 3) mat(1, beta, beta^2; 1, beta^2, beta; 1, 1, 1) mat(V_("aa'"); 0; 0)
$$

$$
therefore V_("aa'1") = V_("aa'2") = V_("aa'0") = frac(1, 3) V_("aa'")
$$

$$
I_(a 1) + I_(a 2) + I_(a 0) = 0
$$
...
$$
Z_1 = frac(j(0.491+0.20) times 0.23, (0.491+0.20) + 0.23) = j 0.172 " p.u."
$$
...
$$
bold(I_(a 1)) = frac(V_f^0, Z_1 + Z_2 + Z_0) = frac(0.909 angle 0°, j(0.172+0.172+3.264)) = -j 0.252 " p.u."
$$
...
$$
"Fault current" = 3 I_(a 0) = 3 times (-j 0.252) = -j 0.756 " p.u."
$$
...
$$
= -j 0.252 times frac(0.23, 0.94) = -j 0.063 " p.u."
$$

**Component of Iₐ₁ flowing towards 'g' from motor side:**

$$
= -j 0.252 times frac(0.691, 0.921) = -j 0.189 " p.u."
$$
...
$$
mat(I_a; I_b; I_c) = mat(1, beta^2, beta; 1, beta, beta^2; 1, 1, 1) mat(I_(a 1); I_(a 2); I_(a 0))
$$
...
$$
Z_0 = j 0.04 + 3 R_n = j 0.04 + frac(3 times 1, (11^2/12))
$$

$$
therefore Z_0 = (0.297 + j 0.04) " p.u."
$$

**Step 3: Fault current calculation**

$$
I_f = I_a = 3 I_(a 1) = frac(3 E_a, (Z_1 + Z_2 + Z_0)) space ["eqn. 7, " Z_f = 0]
$$

$$
therefore I_f = frac(3 times 1 angle 0°, (j 0.045 + j 0.025 + 0.297 + j 0.04))
$$

$$
therefore I_f = 9.472 angle -23.32° " p.u."
$$

**Step 4: Current in grounding resistor**

$$
|I_f| = 9.472 times frac(12, sqrt(3) times 11) " kA" = 5.96 " kA"
$$

**Step 5: Voltage across grounding resistor**

$$
= R_n|I_f| = frac(1, (11^2/12)) times 9.472 = 0.939 " p.u."
$$

$$
= 0.939 times frac(11, sqrt(3)) " kV" = 5.96 " kV"
$$
...
$$
bold(I_(a 1)) = frac(E_a, Z_1 + frac(Z_2(Z_0 + 3 Z_f), Z_2 + Z_0 + 3 Z_f))
$$

With Z_f = 0:

$$
bold(I_(a 1)) = frac(1 angle 0°, j 0.045 + frac(j 0.025 times j 0.04, j 0.025 + j 0.04)) = -j 16.56 " p.u."
$$
...
$$
V_(a 1) = E_a - I_(a 1) times Z_1 = 1 angle 0° - (-j 16.56)(j 0.045) = 0.2548 " p.u."
$$

**Step 4: Negative sequence current**

$$
I_(a 2) = -frac(V_(a 2), Z_2) = -frac(0.2548, j 0.025) = j 10.192 " p.u."
$$

**Step 5: Zero sequence current**

$$
I_(a 0) = -frac(V_(a 0), Z_0) = -frac(0.2548, j 0.04) = j 6.37 " p.u."
$$
...
$$
I_b = beta^2 I_(a 1) + beta I_(a 2) + I_(a 0)
$$

$$
= (-0.5-j 0.866)(-j 16.56) + (-0.5+j 0.866)(j 10.192) + j 6.37
$$

$$
therefore I_b = 25.05 angle 157.6° " p.u."
$$

For I_c:

$$
I_c = beta I_(a 1) + beta^2 I_(a 2) + I_(a 0)
$$

$$
therefore I_c = 25.05 angle 22.4° " p.u."
$$
...
$$
beta^2 V_(a 1) + beta V_(a 2) + V_(a 0) = beta V_(a 1) + beta^2 V_(a 2) + V_(a 0)
$$

$$
(beta^2 - beta) V_(a 1) = (beta^2 - beta) V_(a 2)
$$

$$
therefore V_(a 1) = V_(a 2)
$$

From Vₐ = 0:

$$
V_(a 1) + V_(a 2) + V_(a 0) = 0
$$
...
$$
therefore V_(a 1) = V_(a 2) = -frac(V_(a 0), 2)
$$

From I_b = −I_c:

$$
beta^2 I_(a 1) + beta I_(a 2) + I_(a 0) = -(beta I_(a 1) + beta^2 I_(a 2) + I_(a 0))
$$

$$
(beta^2 + beta) I_(a 1) + (beta^2 + beta) I_(a 2) = -2 I_(a 0)
$$

Using β² + β = −1:

$$
-I_(a 1) - I_(a 2) = -2 I_(a 0)
$$

$$
therefore I_(a 1) + I_(a 2) = 2 I_(a 0)
$$
...
$$
M frac(d^2 delta, dif t^2) = P_m - P_e
$$
...
![Y–Δ zero-sequence network](/content-assets/studies/power-system-analysis/Week%2011/Assets/img-0.jpg)
...
![Sequence impedances from self and mutual impedance](/content-assets/studies/power-system-analysis/Week%2011/Assets/img-8.jpg)
...
![Negative-sequence network for a generator–transformer–line system](/content-assets/studies/power-system-analysis/Week%2011/Assets/img-23.jpg)
...
![Single-line-to-ground fault connection](/content-assets/studies/power-system-analysis/Week%2011/Assets/img-30.jpg)
...
![Line-to-line fault equations](/content-assets/studies/power-system-analysis/Week%2011/Assets/img-39.jpg)
...
![Phase/sequence transformation equations](/content-assets/studies/power-system-analysis/Week%2011/Assets/img-44.jpg)
...
![Zero-sequence machine equation with neutral grounding](/content-assets/studies/power-system-analysis/Week%2011/Assets/img-48.jpg)
...
![Worked sequence-network example for an L–G fault](/content-assets/studies/power-system-analysis/Week%2011/Assets/img-65.jpg)
