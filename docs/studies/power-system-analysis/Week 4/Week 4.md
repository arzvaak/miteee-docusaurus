...
$$
frac(V_("HL"), V_("XL")) = sqrt(3) dot frac(V_("HP"), V_("XP")) = sqrt(3) dot a = sqrt(3) dot frac(N_1, N_2)
$$

This can be rewritten in an alternative form that will become useful:

$$
frac(V_("HL"), V_("XL")) = frac(N_1, (frac(N_2, sqrt(3))))
$$
...
$$
frac(V_("HL"), V_("XL")) = frac(V_("An"), V_("an")) = sqrt(3) dot frac(N_1, N_2)
$$
...
$$
"Per-unit quantity" = frac("actual quantity", "base value of quantity")
$$

More specifically:

$$
S_("pu") = frac(S, S_B), space V_("pu") = frac(V, V_B), space I_("pu") = frac(I, I_B), space Z_("pu") = frac(Z, Z_B)
$$
...
**Complex power:**
$$
S_("pu") = V_("pu") dot I_("pu")^(star)
$$

where $S_("pu") = P_("pu") + j Q_("pu")$. The conjugate appears "to capture the power factor angle, when voltage and currents are purely sinusoidal"—this is essential for load flow studies.

**Ohm's law:**
$$
V_("pu") = Z_("pu") dot I_("pu")
$$
...
$$
S_("load"(3 phi.alt)) = 3 V_("phase") dot I_L^(star)
$$
...
$$
S_("load"(3 phi.alt)) = 3 dot V_("phase") (frac(V_("phase"), Z_L))^(star) = frac(3|V_("phase")|^2, Z_L^(star))
$$

Taking the conjugate on both sides:

$$
Z_L = frac(3|V_("phase")|^2, S_("load"(3 phi.alt))^(star))
$$
...
$$
Z_("pu") = frac(3|V_("phase")|^2, S_("load"(3 phi.alt))^(star)) dot frac(("MVA")_B, ("KV")_B^2)
$$

Using the line-to-line voltage relationship $3|V_("phase")|^2 = |V_(L-L)|^2$:

$$
Z_("pu") = frac(|V_(L-L)|^2, ("KV")_B^2) dot frac(("MVA")_B, S_("load"(3 phi.alt))^(star)) = frac(|V_(L-L)|^2, ("KV")_B^2) dot frac(1, frac(S_("load"(3 phi.alt))^(star), ("MVA")_B))
$$

This simplifies to the elegant final result:

$$
Z_("pu") = frac(|V_("pu")|^2, S_("load"("pu"))^(star))
$$
...
- The derived base relationships: $I_B = ("MVA")_B / (sqrt(3) dot "KV"_B)$ and $Z_B = ("KV")_B^2 / ("MVA")_B$
- Circuit laws in per-unit: $S_("pu") = V_("pu") dot I_("pu")^(star)$ and $V_("pu") = Z_("pu") dot I_("pu")$
- The load impedance formula: $Z_("pu") = |V_("pu")|^2 / S_("load"("pu"))^(star)$
...
$$
Z_("pu","new") = Z_("pu","old") dot frac(("KV")_(B,"old")^2, ("MVA")_(B,"old")) dot frac(("MVA")_(B,"new"), ("KV")_(B,"new")^2)
$$

The derivation logic is straightforward:

1. Old base impedance: $Z_(B,"old") = frac(("KV")_(B,"old")^2, ("MVA")_(B,"old"))$
2. Convert old per-unit to ohmic: $Z(Omega) = Z_("pu","old") dot Z_(B,"old")$
...
- $V_s = V_s("pu") times V_("sB")$
- $V_p = V_p("pu") times V_("pB")$
- $Z_p = Z_p("pu") times Z_("pB")$
- $I_p = I_p("pu") times I_("pB")$
- $Z_s = Z_s("pu") times Z_("sB")$
- $I_s = I_s("pu") times I_("sB")$

Dividing the voltage equation by $V_("sB")$ and using the base relationships:

$$
V_s("pu") = V_p("pu") - I_p("pu") dot Z_p("pu") - I_s("pu") dot Z_s("pu")
$$
...
$$
Z_1("pu") = frac(Z_p, Z_("pB")) + frac(Z_s, Z_("pB") dot a^2)
$$

Using the relationship derived from the base impedances:

$$
frac(Z_("pB"), Z_("sB")) = frac(V_("pB"), I_("pB")) dot frac(I_("sB"), V_("sB")) = frac(1, a^2)
$$
...
$$
Z_s("pu") = frac(Z_(s,"eq"), Z_("sB")) = frac(0.06 angle 78°, 7.744) = 7.74 times 10^(-3) angle 78° " p.u."
$$

**Step 4: Refer impedance to primary side**

$$
Z_(p,"eq") = (frac(N_1, N_2))^2 dot Z_(s,"eq") = (frac(1.1, 0.44))^2 times 0.06 angle 78° = 0.375 angle 78° Omega
$$
...
$$
Z_p("pu") = frac(Z_(p,"eq"), Z_("pB")) = frac(0.375 angle 78°, 48.4) = 7.74 times 10^(-3) angle 78° " p.u."
$$
...
$$
Z_(p,"eq") = frac(Z_(s,"eq"), a^2) = (frac(N_1, N_2))^2 dot Z_(s,"eq")
$$
...
- Section 1 base voltage: $V_(B 1) = 230$ V $= 0.23$ kV
...
- Section 2: $V_(B 2) = (433/230) times 230 = 433$ V $= 0.433$ kV
- Section 3: $V_(B 3) = (120/440) times 433 = 118.09$ V $= 0.11809$ kV


**Step 3: Base impedances for each section**

$$
Z_(B 1) = frac((0.23)^2, 0.003) = 17.63 Omega
$$

$$
Z_(B 2) = frac((0.433)^2, 0.003) = 62.5 Omega
$$

$$
Z_(B 3) = frac((0.11809)^2, 0.003) = 4.64 Omega
$$
...
$$
I_(B 3) = frac(("MVA")_B, V_(B 3)) = frac(0.003, 0.11809) " kA" = 25.4 " A"
$$
...
$$
Z_("BT" 2) = frac((0.44)^2, (2/1000)) = 96.8 Omega
$$

Ohmic value:

$$
X_2(Omega) = X_2("pu") times Z_("BT" 2) = 0.1 times 96.8 = 9.68 Omega
$$

New per-unit value (using section 2 base impedance):

$$
X_(2,"new") = frac(9.68, 62.5) = 0.1548 " p.u."
$$
...
$$
X_("Line")("pu") = frac(X_("Line")(Omega), Z_(B 2)) = frac(3, 62.5) = 0.048 " p.u."
$$

**Step 8: Load impedance**

$$
Z_L("pu") = frac(Z_L(Omega), Z_(B 3)) = frac(0.8 + j 0.3, 4.64) = 0.1724 + j 0.0646 " p.u."
$$
...
$$
V_s("pu") = frac(220 angle 0°, 230) = 0.956 angle 0° " p.u."
$$
...
$$
Z_T("pu") = 0.4058 angle 64.86° " p.u."
$$

**Step 12: Load current in per-unit**

$$
I_L("pu") = frac(V_s, Z_T) = frac(0.956 angle 0°, 0.4058 angle 64.86°) = 2.355 angle -64.86° " p.u."
$$

**Step 13: Load current in Amperes**

$$
I_L = I_L("pu") times I_(B 3) = 2.355 times 25.4 = 59.83 angle -64.86° " A"
$$
...
$$
frac(6.9 sqrt(3), 69 sqrt(3)) = frac(12, 120) " kV"
$$

**Generator-3 circuit base voltage**:

$$
V_(B 3) = frac(12, 120) times 115 = 11.5 " kV"
$$
...
$$
X_(g 1) = 0.2 times frac(30, 25) = 0.24 " p.u."
$$

**Generator G₂**:

$$
X_(g 2) = 0.15 times frac(30, 15) = 0.30 " p.u."
$$

**Generator G₃**:

$$
X_(g 3) = 0.15 times (frac(13.2, 11.5))^2 = 0.20 " p.u."
$$
...
$$
X_(T 2) = 0.10 times frac(30, 15) = 0.20 " p.u."
$$

**Transformer T₃**:

$$
X_(T 3) = 0.10 times (frac(120, 115))^2 = 0.11 " p.u."
$$
...
$$
X_("line"-1) = frac(120, 440) = 0.27 " p.u."
$$

$$
X_("line"-2) = frac(90, 440) = 0.205 " p.u."
$$
...
$$
("KV")_(B,"line") = 33 times frac(110, 32) = 113.43 " kV"
$$
...
$$
Z_(B,T 1) = Z_(B,T 2) = frac((32)^2, 110) = 9.309 Omega
$$

$$
X_(T 1)(Omega) = X_(T 2)(Omega) = 0.08 times 9.309 = 0.744 Omega
$$

$$
X_(T 1,"new") = X_(T 2,"new") = frac(0.744, 10.89) = 0.0683 " p.u."
$$
...
$$
X_("line") = frac(X_("line")(Omega), Z_(B,"line")) = frac(60, 128.66) = 0.466 " p.u."
$$
...
$$
Z_(B,m 1) = frac((30)^2, 40) Omega
$$

Ohmic value:

$$
X_(m 1)(Omega) = 0.20 times frac((30)^2, 40) = 4.5 Omega
$$

New per-unit value:

$$
X_(m 1,"new") = frac(4.5, 10.89) = 0.413 " p.u."
$$

**Step 10: Motor 2 reactance**

$$
X_(m 2,"new") = 0.2 times (frac(100, 30)) times (frac(30, 33))^2 = 0.551 " p.u."
$$

**Step 11: Motor 3 reactance**

$$
X_(m 3,"new") = 0.2 times (frac(100, 20)) times (frac(30, 33))^2 = 0.826 " p.u."
$$
...
$$
Z_(B 1) = frac(("KV")_(B 1)^2, ("MVA")_("Base")) = frac(12.66^2, 1) = 160.27 Omega
$$

$$
Z_(B 2) = frac(("KV")_(B 2)^2, ("MVA")_("Base")) = frac(66^2, 1) = 4356 Omega
$$

Actual reactances referred to primary:

$$
X_1 = 0.1 times 160.27 = 16.027 Omega
$$

$$
X_m = 50 times 160.27 = 8013.5 Omega
$$
...
For 3-phase bank:
- $("MVA")_(B,3 Phi) = 3 times 1 = 3$
- $("KV")_(B,"Line"-"line") = sqrt(3) times 12.66$ KV

$$
Z_(B 1) = frac(("KV")_(B,"ll")^2, ("MVA")_(B,3 Phi)) = frac((sqrt(3) times 12.66)^2, 3) = 160.27 Omega
$$

**Key result**: The base impedance is the same whether computed on single-phase or three-phase basis.

$$
X_1("pu") = frac(16.027, 160.27) = 0.1 " p.u."
$$

$$
X_m("pu") = frac(8013.5, 160.27) = 50 " p.u."
$$
...
| Component | Rating | Reactance |
|-----------|--------|-----------|
| Generator G₁ | 50 MVA, 12.2 KV | $X_(g 1) = 0.10$ p.u. |
| Generator G₂ | 20 MVA, 13.8 KV | $X_(g 2) = 0.10$ p.u. |
| Transformer T₁ | 80 MVA, 12.2/132 KV | $X_(T 1) = 0.10$ p.u. |
| Transformer T₂ | 40 MVA, 13.8/132 KV | $X_(T 2) = 0.10$ p.u. |
| Line 1-2 | — | $Z = 4 + j 16 Omega$ |
| Line 1-3 | — | $Z = 2 + j 8 Omega$ |
| Line 2-3 | — | $Z = 2 + j 8 Omega$ |
...
$$
V_(B,G 1) = 100 times frac(12.2, 132) = 9.24 " KV"
$$

$$
V_(B,G 2) = 100 times frac(13.8, 132) = 10.45 " KV"
$$
...
$$
X_("new") = X_("old") times frac(("MVA")_(B,"new"), ("MVA")_(B,"old")) times frac(("KV")_(B,"old")^2, ("KV")_(B,"new")^2)
$$
...
$$
X_(g 1,"new") = 0.10 times (frac(100, 50)) times (frac(12.2, 9.24))^2 = 0.3486 " pu"
$$

$$
X_(g 2,"new") = 0.10 times (frac(100, 20)) times (frac(13.8, 10.48))^2 = 0.8719 " pu"
$$

$$
X_(T 1,"new") = 0.1 times (frac(100, 80)) times (frac(12.2, 9.24))^2 = 0.2179 " pu"
$$

$$
X_(T 2,"new") = 0.1 times (frac(100, 40)) times (frac(13.8, 10.48))^2 = 0.33 " pu"
$$
...
$$
Z_(12)("pu") = frac(Z_(12)(Omega), Z_(B,"line")) = frac((4 + j 16), 100) = (0.04 + j 0.16) " pu"
$$

$$
Z_(13)("pu") = Z_(23)("pu") = frac((2 + j 8), 100) = (0.02 + j 0.08) " pu"
$$

**Step 4: Load representation**

$$
S = 50(0.8 + j 0.6) = (40 + j 30) " MVA"
$$

**Instructor note on sign convention**: "If lagging power factor is given right for the load that mean load actually is load means its consuming power right is consuming power from the source right. So, whenever load is lagging power factor means it will be $0.8 + j 0.6$ right. So, I suggest they do not take it minus then, then it will be mistake because load consume powers of convention is that load always consume power and generator it actually injects power into the line right."

**Series combination of resistance and reactance**:

$$
Z_("Load")^(*)(Omega) = frac((124)^2, (40 + j 30)) = 307.52 angle -36.87^degree Omega
$$
...
$$
(Z_("Load"))^(*)("pu") = frac(307.52 angle -36.87^degree, 100) = 2.46 + j 1.84 " pu"
$$

Taking conjugate on both sides:

$$
Z_("Load")("pu") = 2.46 + j 1.845 " pu"
$$
...
$$
R_("parallel")("pu") = frac(384.4, 100) = 3.844 " pu"
$$
...
$$
X_("parallel")("pu") = frac(512.5, 100) = 5.125 " pu"
$$
...
- $V_(B 1) = 13.8$ KV (generator side)
- $V_(B 2) = 13.8 times frac(220, 13.8) = 220$ KV (line-1 side)
- $V_(B 3) = 220$ KV (high voltage side of T₂)
- $V_(B 4) = 220 times frac(11, 220) = 11$ KV (low voltage side of T₂)
- $V_(B 5) = V_(B 6) = 13.8 times frac(132, 13.8) = 132$ KV (line-2 side)
...
$$
X_(g 1) = 0.18 times frac(100, 90) = 0.20 " pu"
$$

$$
X_(T 1) = X_(T 2) = X_(T 3) = X_(T 4) = 0.10 times (frac(100, 50)) = 0.20 " pu"
$$

**Step 3: Motor reactance**

$$
X_(m,"new")("pu") = X_(m,"old")("pu") times frac(("MVA")_(b,"new"), ("MVA")_(b,"old")) times frac(("KV")_(b,"old")^2, ("KV")_(b,"new")^2)
$$
...
$$
X_(m,"new")("pu") = 0.2 times frac(100, 80) times (frac(10.45, 11))^2 = 0.2256 " pu"
$$

**Step 4: Line base impedances**

$$
Z_(B,2-3) = frac((V_(B 2))^2, ("MVA")_B) = frac((220)^2, 100) = 484 Omega
$$

$$
Z_(B,5-6) = frac((V_(B 5))^2, ("MVA")_B) = frac((132)^2, 100) = 174.24 Omega
$$

$$
X_("line"-1) = frac(50, 484) = 0.1033 " pu"
$$

$$
X_("line"-2) = frac(70, 174.24) = 0.4017 " pu"
$$

**Step 5: Load impedance calculation**

$$
S_L(3 Phi) = 57 angle 36.87^degree " MVA"
$$

$$
Z_L = frac((V_("LL"))^2, S_(L(3 Phi))) = frac((10.45)^2, 57 angle -36.87^degree) = 1.532 + j 1.1495 Omega
$$
...
$$
Z_L("pu") = frac(1.532 + j 1.1495, 1.21) = 1.266 + j 0.95 " pu"
$$
...
- The sign convention for lagging power factor loads: $S = P + j Q$ (positive reactive power)
...
- $V_S = t_S times V_1$ (magnitude-wise)
- $V_R = t_R times V_2$ (magnitude-wise)
...
$$
t_S = frac(1, |V_1|)(t_R|V_2| + frac("PR" + "QX", t_R|V_2|))
$$

**Assumption**: $t_S times t_R = 1$
...
$$
t_S = [frac(|V_2|, |V_1|)(1 - frac("PR" + "QX", |V_1||V_2|))^(-1)]^(1/2)
$$
...
$$
P = frac(1, 3) times 105 times 0.8 = 28 " MW"
$$

$$
Q = frac(1, 3) times 105 times 0.6 = 21 " MVAR"
$$
...
$$
|V_1| = |V_2| = frac(220, sqrt(3)) = 127.017 " KV"
$$
...
$$
t_S = [1 times (1 - frac(28 times 20 + 21 times 120, 127.017 times 127.017))^(-1)]^(1/2) = 1.11
$$
...
**Problem**: "Determine the transformer tap ratios when the receiving end voltage is equal to the sending end voltage. The high voltage line operates at 220 KV and transmit 80 megawatt at 0.8 power factor lag and the impedance of the line is $40 + j 140 Omega$. Assume $t_S times t_R = 1$"
...
$$
P = frac(1, 3) times 80 times 0.8 = 21.33 " MW"
$$

$$
Q = frac(1, 3) times 80 times 0.6 = 16 " MVAR"
$$
...
Let $Delta V_("bc") = a times V_("bc")$ where $a$ is a fraction.

For balanced system:

$$
V_("bc") = sqrt(3) times V_("an") angle -90^degree
$$

Therefore:

$$
Delta V_("bc") = a sqrt(3) V_("an") angle -90^degree = -j a sqrt(3) V_("an")
$$

Substituting:

$$
V_("an")' = (1 - j a sqrt(3)) V_("an")
$$
...
- The radial line tap ratio derivation: $t_S = [frac(|V_2|, |V_1|)(1 - frac("PR" + "QX", |V_1||V_2|))^(-1)]^(1/2)$
...
|----------|-------------|------------|
| (2) | Per-unit definition | $"Per-unit" = frac("actual", "base")$ |
...
| (5) | Base impedance (form 1) | $Z_B = frac(("KV")_B, sqrt(3) dot I_B)$ |
| (6) | Base impedance (form 2) | $Z_B = frac(("KV")_B^2, ("MVA")_B)$ |
| (7) | Complex power in pu | $S_("pu") = V_("pu") dot I_("pu")^(star)$ |
| (8) | Ohm's law in pu | $V_("pu") = Z_("pu") dot I_("pu")$ |
| (11) | Load impedance | $Z_L = frac(3|V_("phase")|^2, S_("load"(3 phi.alt))^(star))$ |
| (15) | Load impedance in pu | $Z_("pu") = frac(|V_("pu")|^2, S_("load"("pu"))^(star))$ |
| (16) | Base change | $Z_("pu","new") = Z_("pu","old") dot frac(("KV")_(B,"old")^2, ("MVA")_(B,"old")) dot frac(("MVA")_(B,"new"), ("KV")_(B,"new")^2)$ |
...
| (29) | Transformer pu equation | $V_s("pu") = V_p("pu") - I("pu") dot Z("pu")$ |
...
| (43) | Tap ratio formula | $t_S = [frac(|V_2|, |V_1|)(1 - frac("PR" + "QX", |V_1||V_2|))^(-1)]^(1/2)$ |
| (44) | In-phase booster | $V_("an")' = V_("an") + Delta V_("an")$ |
| (45) | Phase-shifting booster | $V_("an")' = V_("an") + Delta V_("bc")$ |
| (46) | Quadrature injection | $Delta V_("bc") = -j a sqrt(3) V_("an")$ |
| (47) | Phase-shifted output | $V_("an")' = (1 - j a sqrt(3)) V_("an")$ |
...
![Y–Y transformer connection, single-phase equivalent, and single-line diagram](/content-assets/studies/power-system-analysis/Week%204/Assets/img-5.jpg)
...
![Per-unit load-impedance derivation](/content-assets/studies/power-system-analysis/Week%204/Assets/img-18.jpg)
...
![Single-phase transformer equivalent circuit with turns ratio](/content-assets/studies/power-system-analysis/Week%204/Assets/img-22.jpg)
...
![Worked per-unit base-impedance calculation](/content-assets/studies/power-system-analysis/Week%204/Assets/img-38.jpg)
...
![Three-generator power-system single-line diagram](/content-assets/studies/power-system-analysis/Week%204/Assets/img-49.jpg)
...
![Per-unit reactance diagram for a generator-transformer-line-motor system](/content-assets/studies/power-system-analysis/Week%204/Assets/img-53.jpg)

The hand-drawn network replaces the physical system with series reactance elements and machine branches. Read it from the generator around the top line toward the transformer and motor branches, retaining each $j X$ label as a separate element; the small numeric reactances should be verified from the worked text.

### Lecture 19 — Final per-unit equivalent circuit (physical PDF page 213)

![Final per-unit equivalent circuit for a multi-transformer system](/content-assets/studies/power-system-analysis/Week%204/Assets/img-68.jpg)
...
![Voltage phase-shift phasor diagram for transformer voltage control](/content-assets/studies/power-system-analysis/Week%204/Assets/img-90.jpg)
...
7. **Forgetting the conjugate in complex power expressions** — $S = "VI"^(star)$ is essential for capturing power factor angle.
...
9. **Wrong sign for lagging power factor load** — "whenever load is lagging power factor means it will be $0.8 + j 0.6$ right. So, I suggest they do not take it minus then, then it will be mistake because load consume powers of convention is that load always consume power"
...
- $frac(V_("HL"), V_("XL")) = sqrt(3) dot frac(N_1, N_2)$
...
- $Delta V_("bc") = -j a sqrt(3) V_("an")$ (quadrature injection)
...
Options:
(a) $frac(N_1, N_2)$
(b) $sqrt(3) dot frac(N_1, N_2)$
(c) $frac(N_1, sqrt(3) dot N_2)$
(d) $frac(sqrt(3) dot N_2, N_1)$
...
$$
frac(V_("HL"), V_("XL")) = frac(sqrt(3) dot V_("HP"), V_("XP")) = sqrt(3) dot frac(N_1, N_2)
$$
...
$$
X_("new") = 0.2 times frac(30, 25) = 0.24 " p.u."
$$
...
> Answer and explanation
> The correct answer is (b). The current base ratio is the reciprocal of the voltage base ratio. Since $frac(V_("pB"), V_("sB")) = frac(1, a)$, and the power base is the same on both sides ($V_("pB") dot I_("pB") = V_("sB") dot I_("sB")$), we get:
$$
...
$$
S = P + j Q = 50(0.8) + j 50(0.6) = 40 + j 30 " MVA"
$$
> The instructor emphasizes: "whenever load is lagging power factor means it will be $0.8 + j 0.6$ right. So, I suggest they do not take it minus then, then it will be mistake because load consume powers of convention is that load always consume power"
...
What is the significance of the conjugate in the complex power expression $S_("pu") = V_("pu") dot I_("pu")^(star)$?
...
What is the assumption $t_S times t_R = 1$ in the tap ratio derivation, and why is it made?

> Answer and explanation
> The assumption $t_S times t_R = 1$ ensures that "the overall voltage level remains the same order and that the minimum range of taps on both transformer is used." This means that if the sending end transformer steps up by a factor $t_S$, the receiving end transformer steps down by the reciprocal $1/t_S$, maintaining the overall voltage level. This is a practical design choice that minimizes the tap range needed on each transformer.
...
> Answer and explanation
> The per-unit values remain the same because the base impedance is invariant. For single-phase: $Z_(B 1) = frac(("KV")_(B 1)^2, ("MVA")_("Base"))$. For three-phase: $Z_(B 1) = frac(("KV")_(B,"ll")^2, ("MVA")_(B,3 Phi)) = frac((sqrt(3) times 12.66)^2, 3) = frac(3 times 12.66^2, 3) = frac(12.66^2, 1)$. The $sqrt(3)$ factor in the voltage and the factor of 3 in the MVA cancel out, giving the same base impedance. Therefore, the per-unit values are identical.
...
Options:
(a) $7.74 times 10^(-3) angle 78°$ p.u.
(b) $7.74 times 10^(-2) angle 78°$ p.u.
...
> Step 3: Per-unit impedance: $Z_s("pu") = frac(0.06 angle 78°, 7.744) = 7.74 times 10^(-3) angle 78°$ p.u.
...
$$
t_S = [1 times (1 - frac(28 times 20 + 21 times 120, 127.017 times 127.017))^(-1)]^(1/2)
$$
$$
t_S = [(1 - frac(560 + 2520, 16133.3))^(-1)]^(1/2) = [(1 - 0.1909)^(-1)]^(1/2)
$$
$$
t_S = [frac(1, 0.8091)]^(1/2) = [1.236]^(1/2) = 1.11
$$
...
A three-phase transmission line feeds a 105 MVA, 0.8 pf lagging load through transformers. The total impedance of the line and transformers at 220 kV is $(20 + j 120) Omega$. The sending end transformer is energized from a 13.8 kV supply. What are the tap settings $t_S$ and $t_R$ to maintain the voltage at 13.8 kV?
...
t_S = [1 times (1 - frac(28 times 20 + 21 times 120, 127.017 times 127.017))^(-1)]^(1/2) = 1.11
$$
> Step 4: Using the assumption $t_S times t_R = 1$:
$$
t_R = frac(1, t_S) = frac(1, 1.11) = 0.90
$$
