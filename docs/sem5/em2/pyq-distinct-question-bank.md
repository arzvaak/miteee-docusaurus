...
|---|---|---|
| Q13 | Q4 | same winding-factor and EMF numerical task; only source wording changes |
| Q14 | Q4 | same winding-factor and EMF numerical task; only source wording changes |
| Q17 | Q3 | same harmonic phase-voltage task; only formatting/source wording changes |
| Q20 | Q4 | same winding-factor and EMF numerical task; only source wording changes |
| Q24 | Q22 | removed from distinct bank by request; same rotor-slip calculation area |
| Q25 | Q24 | removed from distinct bank by request; rotor EMF injection theory paired with removed numerical task |
| Q61 | Q58 | same circle-diagram task and requested outputs; only formatting changes |
| Q93 | Q91 | same armature-reaction theory question |
| Q94 | Q92 | same synchronous-motor UPF/excitation numerical task |
| Q101 | Q90 | same alternator voltage-regulation numerical task |
| Q103 | Q85 | same varying-excitation phasor-diagram question |
| Q106 | Q104 | same synchronizing conditions and two-bright one-dark method question |
| Q118 | Q115 | same reluctance-power salient-pole theory question |
| Q119 | Q117 | same Blondel two-reaction phasor-diagram question |
| Q136 | Q133 | same plant kVA and overall power-factor task; only values change |
| Q140 | Q126 | same parallel alternator maximum-power task; only unit formatting changes |
